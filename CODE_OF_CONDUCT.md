...
repository, issue tracker, discussions, and any other channel officially
associated with the project. It also applies when an individual is representing
...
**conduct@laurent-ongaro.example** (replace with the project's real contact).
